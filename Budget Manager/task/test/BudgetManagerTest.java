...
public class BudgetManagerTest extends StageTest<String> {
    ...
    @Before
    public void createTempPurchaseFile() {
        File tempFile = new File("temp_purchase_file.txt");
        File orgFile  = new File("purchases.txt");

        try {
            copyFileToFile(orgFile, tempFile);
        } catch (IOException e) {
            // ignore if purchases.txt file is not found
        }
    ...
    public void removeFiles(){
        ...
        try {
            if (tempFile.exists()) {
                copyFileToFile(tempFile, purchaseFile);
                tempFile.delete();
            } else {
                tempFile.delete();
                purchaseFile.delete();
            ...
            // ignore if files aren't found for deletion
        }
    }
